  ...
  <div class="loginContainer well well-sm">
    ...
    <g:form action="signIn" class="loginForm list-group">    
    	<input class="list-group-item" type="hidden" name="targetUri" value="${targetUri}" />    
      	...
      	<input class="list-group-item" type="text" name="username" value="${username}" placeholder="Username" />       
      	<!-- <label for="password">Password</label> -->
      	<input class="list-group-item" type="password" name="password" value=""  placeholder="Password"/> 
